...
| Done | Sketch draft mesh preview backend | Sketch draft source renders through Ecky mesh backend into `ArtifactBundle` with model STL and viewer assets. |
...
- Successful sketch previews now hand off to the main model viewport with compact model STL and asset-count evidence.
