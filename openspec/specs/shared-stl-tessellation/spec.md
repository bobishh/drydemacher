# shared-stl-tessellation Specification

## Purpose
TBD - created by archiving change shared-stl-tessellation-quality. Update Purpose after archive.
## Requirements
...
model STL and per-part STL output. The initial policy SHALL use linear
