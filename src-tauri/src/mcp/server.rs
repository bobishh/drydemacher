...
pub const MCP_BIND_ADDR: &str = "127.0.0.1:39249";
pub const MCP_ENDPOINT_URL: &str = "http://127.0.0.1:39249/mcp";
...
fn tool_definitions() -> Vec<Value> {
    vec![
        ...
        json!({
            ...
            "description": "Replace macro code and rerender a draft. Works without prior browsing by resolving the default target automatically.",
            "inputSchema": with_identity(
                &[
                    ("threadId", json!({ "type": "string" })),
                    ("messageId", json!({ "type": "string" })),
